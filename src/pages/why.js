      ...
      <div className="home-content">
        <div>
          <section className="hero">
            <small style={{ marginTop: '4rem', marginBottom: '1rem' }}>A Venus project</small>
            ...
            <p>
              Venus is a token marketplace that faces the issues of token reputation directly. Until now, the Venus
              team took on the responsibility of curating the tokens that show up in the Venus Interface. While this
              was important to get the project off the ground and protect the users of Venus, having the Venus team
            ...
            <p>
              ...
              That power residing solely in the Venus team was against the ethos of the protocol and the broader DeFi
              ecosystem.
            </p>
