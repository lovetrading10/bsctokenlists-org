...
export default function Header({ back }) {
  return (
    <StyledHeader>
      ...
      <Nav>
        <a target="_blank" rel="noopener noreferrer" className="hide-small" href="http://community.venus.io/">
          Community
        </a>
        <a
          target="_blank"
          ...
          href="https://venus.io/blog/token-lists/"
        >
          Why lists?
        </a>
        <a
        ...
        <ButtonLink
          ...
          target="_blank"
          rel="noopener noreferrer"
          href="https://github.com/VenusProtocol/token-lists"
        >
          <img
            style={{
              filter: 'invert(1)',
